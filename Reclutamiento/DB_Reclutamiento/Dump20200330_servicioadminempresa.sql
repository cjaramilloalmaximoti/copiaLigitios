CREATE DATABASE  IF NOT EXISTS `servicioadminempresa` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `servicioadminempresa`;
-- MySQL dump 10.13  Distrib 8.0.19, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: servicioadminempresa
-- ------------------------------------------------------
...
INSERT INTO `administrador` VALUES (1,'@AlMaximoTI.com','clugo','+8gNci97Kp/Rex0XrtGLlg==','daniel.aceves@almaximoti.com');
...
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='La entidad Empresa representa a cada uno de nuestros clientes';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `empresa` VALUES (1,'@HumanFactor.com','RFCA010101','Human Factor SA','Jaime Celaya','jCelaya@gmail.com','123','',NULL,'1','1','1',1,1,15,15,5,NULL,NULL),(2,'@gmail.com','RFCA010101ABC','Alex','Alejandro Gutierrez','alex@gmail.com','123','',NULL,'1','1','1',1,1,15,15,5,NULL,NULL),(3,'@Alex.com','GURL850319','Alex','Alejandro Gutierrez','alex@gmail.com','123','',NULL,'1','1','1',1,1,15,15,5,NULL,NULL),(4,'@ROBERTO.COM','PRUEBA','ROBERTO','PRUEBA','PRUEBA@HOTMAIL.COM','123456','',NULL,'1','1','1',1,1,15,15,5,NULL,NULL),(5,'@PruebaNueva.com','MOCM110896HT','Prueba Nueva SA de CV','Hector Lopez','hector@PruebaNueva.com','4777607682','',NULL,'','','',1,1,19,19,19,NULL,NULL),(6,'Eustaquio','2ssss','5','q','','q','',NULL,'q','','q',1,1,1,1,1,NULL,NULL),(7,'@PruebaUno','MAN960106BN8','Pedro Capo','Pedro Capo','PedroReal@Capo.com','4771234567','',NULL,'Juan Escutia','Juan@escutia.com','477234568',1,1,5,10000,1,NULL,NULL),(8,'@juancompany.com','MHW123456WN9','Juan Company SA de CV','Juan Jaramillo','jj@hotmail.com','4771234567','',NULL,'Abraham Rodriguez','abraham.rodriguez@gmail.com','4771234568',1,1,9,100,1,NULL,NULL),(10,'@techmex.com','TEM981212MN8','Tecnología Mexicana S.A. de C.V.','Damian Robledo Matamoros','damian_robledo@gmail.com','4771236548','','Camina lento','Miguel Jimenez Ezquerra','miguel_je@outlook.com','4779871235',1,1,2,9,2,NULL,NULL),(11,'@MovilZone.com','MVZ981212MN2','Movil Zone C.V.','Josue Muñoz Gaitan','jgaitan@ymail.com','4776587415','','Nada juerte','Patricio Anguiano Moreno','patriciomoreno@outlook.com','4776842679',1,1,1,1,1,NULL,NULL);
...
CREATE TABLE `parametro` (
  ...
  `EsActivo` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'campo que nos dice un parametro esta activo o no activo',
  `EsSensitivo` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Campo que nos dice si es legible a simple vista o debe estar oculto',
...
-- Dump completed on 2020-03-30 17:36:38
