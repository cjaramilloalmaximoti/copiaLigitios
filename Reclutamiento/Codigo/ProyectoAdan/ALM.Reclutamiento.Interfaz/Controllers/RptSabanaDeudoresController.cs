...
namespace ALM.Empresa.Interfaz.Controllers
{
    ...
    public class RptSabanaDeudoresController : Controller
    {
        /*
        [CustomAuthorize(AccessLevel = InformacionUsuarioLogueado.Privilegio.Privilegio1, Accion = "RptSabanaDeudores_Index")]
        public ActionResult RptSabanaDeudores_Index()
        {
            return View();
        }
        ...
        [CustomAuthorize(AccessLevel = InformacionUsuarioLogueado.Privilegio.Privilegio1, Accion = "RptSabanaDeudores_Index")]
        public ActionResult RptSabanaDeudores_Exportar(string nombreArchivo)
        {
        ...
        [HttpPost]
        [CustomAuthorize(AccessLevel = InformacionUsuarioLogueado.Privilegio.Privilegio1, Accion = "RptSabanaDeudores_Index")]
        public ActionResult ObtenerReporteSabana(int? pIdCartera, int? pIdUsuario, int? pIdSegmento, int pIdTipoEstatus, int pActivo)
        {
            Respuesta dataRespuesta = new Respuesta();
            try
            {
                ...
                var archivo = new NReportes().ObtenerReporteSabana(pIdCartera, pIdUsuario, pIdSegmento, InformacionUsuarioLogueado.IdEmpresa, pIdTipoEstatus, pActivo, EClaseEstatica.RutaPublicado + @"Archivos\");
