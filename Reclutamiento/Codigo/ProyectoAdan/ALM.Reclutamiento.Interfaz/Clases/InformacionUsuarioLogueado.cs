    ...
    public static class InformacionUsuarioLogueado
    {
        ...
        public static void EstablecerInformacionUsuario(EUsuario usuario, string rutaLocal)
        {
            ...
            try
            {
                ...
                HttpContext.Current.Session["RutaLogo"] = !string.IsNullOrEmpty(empresa.RutaLogo) && File.Exists(rutaLocal + @"Imagenes\" + empresa.IdEmpresa.ToString() + @"\" + empresa.RutaLogo) ? @"Imagenes\" + empresa.IdEmpresa.ToString() + @"\" + empresa.RutaLogo : "Imagenes/LogoPrincipal.png";
            }
            finally
            {
                empresa = null;
