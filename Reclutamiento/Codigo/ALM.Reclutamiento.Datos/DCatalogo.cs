    ...
    public class DCatalogo : Conexion
    {
        ...
        public List<ECatalogo> ObtCatalogoCtrlCaracteristica(int idCaracteristicaParticular, int idEmpresa)
        {
            try
            {
                ...
                accesoDatos.LimpiarParametros();
                accesoDatos.TipoComando = CommandType.StoredProcedure;
                accesoDatos.Consulta = accesoDatos.ObtenerConsultaXml(Constante.RutaSP, "SPObtCatalogoCtrlCaracteristica");

                accesoDatos.ListaParametros.Add(new MySqlParameter("pIdCaracteristicaParticular", idCaracteristicaParticular));
                accesoDatos.ListaParametros.Add(new MySqlParameter("pIdEmpresa", idEmpresa));
