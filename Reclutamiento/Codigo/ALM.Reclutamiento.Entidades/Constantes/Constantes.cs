...
namespace ALM.Reclutamiento.Entidades
{
    public class Constante
    {
        ...
        public const string ArchivoDocumento = @"^.*\.(docx|xlsx|jpg|png|pdf|pptx|gif|doc|xls|ppt|txt|DOCX|XLSX|JPG|PNG|PDF|PPTX|GIF|DOC|XLS|PPT|TXT)$";
        public const string FormatoIncorrectoDocumento = "Selecciona un archivo docx,xlsx,jpg,png,pdf,pptx,gif,doc,xls,ppt,txt.";
